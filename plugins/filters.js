...
Julie.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if (!!message.mention && message.mention[0] == '918139058539@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/anumwol.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.MENTION) {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/brutal.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        
const array = ['mention','anumwol','brutal','Crypto','Brutal']
array.map( async (a) => {
...
if(pattern.test(message.message)){
    ...
    Julie.addCommand({on: 'text', fromMe: false}, (async (message, match) => {   
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '918139058539@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./files/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,contextInfo: { forwardingScore: 5, isForwarded: true }, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.MENTION) {
...
Julie.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    ...
    let banned = jid.find( Jid => Jid === message.jid);
    if(banned !== undefined) return
    if (!!message.mention && message.mention[0] == '917356484508@s.whatsapp.net') {
